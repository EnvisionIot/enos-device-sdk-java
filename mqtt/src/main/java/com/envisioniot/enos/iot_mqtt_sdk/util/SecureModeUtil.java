...
import com.envisioniot.enos.iot_mqtt_sdk.core.login.MessageIntegrationLoginInput;
...
public class SecureModeUtil {
    ...
    public final static String INTEGRATION_DK = MessageIntegrationLoginInput.INTEGRATION_DK;
